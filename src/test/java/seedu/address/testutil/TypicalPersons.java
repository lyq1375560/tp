...
public class TypicalPersons {
    ...
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withProducts("Red velvet cupcakes")
            .withLocation("wall street").withDeadline("2026-04-01").withContact("95352563").build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withProducts("Tiramisu")
            .withLocation("10th street").withDeadline("2026-04-02").withContact("87652533").build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withProducts("Cheesecake")
            .withLocation("michegan ave").withDeadline("2026-04-03").withContact("94822240").build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withProducts("Chocolate tart")
            .withLocation("little tokyo").withDeadline("2026-04-04").withContact("94824270").build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withProducts("Macarons")
            .withLocation("4th street").withDeadline("2026-04-05").withContact("94824420").build();

    // Manually added
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withProducts("Brownies")
            .withLocation("little india").withDeadline("2026-04-06").withContact("84824240").build();
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withProducts("Croissants")
